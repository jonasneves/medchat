...
APP_NAME = "medchat-workflows"
HOMEPAGE = "https://github.com/jonasneves/medchat"
DESCRIPTION = "Workflow automation for medchat"

PERMISSIONS = {
    "actions": "write",  # Trigger/cancel workflows, restart before timeout
    "contents": "write",
    "issues": "write",
    "pull_requests": "write",
